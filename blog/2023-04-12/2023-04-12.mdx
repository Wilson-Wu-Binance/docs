...
sidebarTitle: 'Zero-Knowledge Proof and Its Application in Blockchain'
---
...
| First Von-Neuman Machine | Blockchain Virtual Machine |
| ------------------------------ | ---------------------------------------------------------------------------------------------- |
| ![](image/IAS.jpeg) | ![](image/EVM.jpg) |
